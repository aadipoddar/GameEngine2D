...
namespace GameEngine
{
    public class Character : AnimatedObject
    {
        ...
        //Custom the feel of our movement
        protected float decel = 1.2f;//the lower the decel is , the slower you slow down
        protected float accel = 0.78f;//the lower the accel is , the slower you take off.
        protected float maxSpeed = 5f;

        const float gravity = 1f;
        const float jumpVelocity = 10f;//how much we jump
